		...
		return new Promise((resolve, reject)=> {
			try {
				...
				boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
					...
					const codigoDeBarras = boleto.codigoDeBarras; // banco.geraCodigoDeBarrasPara(boleto);
					const linhaDigitavel = boleto.linhaDigitavel; // GeradorDeLinhaDigitavel(codigoDeBarras, banco);
