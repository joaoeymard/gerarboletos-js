...
var GeradorDeBoleto = (function () {
      ...
      try {
        ...
        boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
          ...
          pdf
            ...
            .lineTo(
              args.ajusteX +
                (banco.exibirReciboDoPagadorCompleto() ? 572 : 329),
              args.ajusteY + linha3
            )
            .stroke(args.corDoLayout);
          ...
          if (banco.exibirReciboDoPagadorCompleto()) {
            ...
            pdf
              .moveTo(
                args.ajusteX + coluna8Opcional,
                args.ajusteY + linha2 - 0.5
              )
              .lineTo(
                args.ajusteX + coluna8Opcional,
                args.ajusteY + linha3 + 0.5
          ...
          var caminhoParaTesoura = path.join(
            __dirname,
            "imagens/tesoura128.png"
          );
          pdf.image(
            caminhoParaTesoura,
            args.ajusteX + margemDoSegundoBlocoLayout,
          ...
          const codigoDeBarras = boleto._codigoDeBarras; // banco.geraCodigoDeBarrasPara(boleto);
          const linhaDigitavel = boleto._linhaDigitavel; // GeradorDeLinhaDigitavel(codigoDeBarras, banco);
          ...
          var quartaLinha = terceiraLinha + 24,
            tituloDaQuartaLinhaLateral =
              quartaLinha - diferencaEntreTituloEValor;
          ...
          var quintaLinha = quartaLinha + ESPACO_ENTRE_LINHAS,
            ...
            tituloDaQuintaLinhaLateral =
              quintaLinha - diferencaEntreTituloEValor;
  ...
  GeradorDeBoleto.prototype.gerarLinhaDigitavel = function () {
    return new Promise((resolve) => {
      const boletos = this._boletos;
      const linhaDigitavel = boletos.map((boleto, indice) =>
        boleto.getLinhaDigitavelFormatado()
      );
